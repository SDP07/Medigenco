...
@section('content')
<div>
    <h1 class="page-header text-overflow">{{ translate('Add Doctor') }}</h1>
</div>
<div class="row">
	<div class="col-lg-8 col-lg-offset-2">
		<form class="form form-horizontal mar-top" action="{{route('doctors.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
			@csrf
			...
			<div class="panel">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-lg-7">
							<input type="text" class="form-control" name="name" placeholder="{{ translate('Doctor Name') }}" required>
						</div>
					</div>
					<div class="form-group">
			...
			<div class="panel">
				...
				<div class="panel-body">
						...
						<div class="col-lg-7">
							<select class="form-control demo-select2-placeholder" name="special_id" id="category_id" required>
								@foreach($specs as $spec)
									<option value="{{$spec->id}}">{{__($spec->name)}}</option>
								@endforeach
							</select>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-lg-7">
							<input type="text" placeholder="{{ translate('Qualification') }}" name="qualification" class="form-control" required>
						</div>
					</div>
			...
			<div class="panel">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-lg-9">
							<input type="text" class="form-control" name="dispensary" placeholder="{{ translate('Dispensary Name') }}">
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label">{{translate('Clinic Address')}}</label>
						<div class="col-lg-7">
							<textarea class="form-control" name="cliAddress" placeholder="{{ translate('Clinic Address') }}" cols="12" rows="5"></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label">{{translate('Clinic Phone')}}</label>
						<div class="col-lg-9">
							<input type="number" class="form-control" name="clinPhone"  placeholder="{{ translate('Clinic Phone Number') }}">
						</div>
					</div>
					<div class="form-group">
