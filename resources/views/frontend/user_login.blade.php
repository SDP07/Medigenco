                    ...
                    <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 mx-auto">
                        <div class="card" style="border: none;">
                            <div class="text-center px-35 pt-5">
                                ...
                                <img src="https://happygrocery.in/api/public/uploads/logo/j6OWdZpQmJng2r7GSexbqT6PgKfHsprCkNMSSRFl.png" alt="Happy Grocery">
                            </div>
                                ...
                                <div class="">
                                    <form class="form-default" role="form" action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            @if (\App\Addon::where('unique_identifier', 'otp_system')->first() != null && \App\Addon::where('unique_identifier', 'otp_system')->first()->activated)
                                                <input style="border-color: #ffc107;border-radius: 90px;" type="text" class="form-control h-auto form-control-lg {{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}" placeholder="{{ translate('Email Or Phone')}}" name="email" id="email">
                                            @else
                                                <input style="border-color: #ffc107;border-radius: 90px;" type="email" class="form-control h-auto form-control-lg {{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}" placeholder="{{  translate('Email') }}" name="email">
                                            @endif
                                        </div>

                                        <div class="form-group">
                                            <input style="border-color: #ffc107;border-radius: 90px;" type="password" class="form-control h-auto form-control-lg {{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{ translate('Password')}}" name="password" id="password">
                                        </div>
                                            ...
                                            <div class="col-6" hidden>
                                                <div class="form-group">
                                                    <div class="checkbox pad-btm text-left">
                                                        <input id="demo-form-checkbox" class="magic-checkbox" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }} checked>
                                        ...
                                        <div class="text-center">
                                            <button style="border-radius: 90px;" type="submit" class="btn btn-styled btn-base-1 btn-md w-100">{{  translate('Login') }}</button>
                                        </div>
                                    </form>
                                    ...
                                    <div class="text-center">
                                            ...
                                            <a href="{{ route('user.registration') }}" style="border-radius: 90px;" class="btn btn-styled btn-base-1 btn-md w-100">{{  translate('Sign Up') }}</a>
                                     <br><br>
