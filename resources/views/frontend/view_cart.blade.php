...
@endphp
  ...
  <div class="container" id="cart-summary2">
       @if(Session::has('cart'))
                            ...
                            <div class="row">
                                ...
                                <div class="col-auto align-self-center">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="number" name="quantity[{{ $key }}]" class="form-control disabled w-35" placeholder="1" value="{{ $cartItem['quantity'] }}" min="1" max="{{ $product->current_stock }}" onchange="updateQuantity({{ $key }}, this)" disabled>
