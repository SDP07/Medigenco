...
<script type="text/javascript">
		...
		var x = document.getElementById("devicec");
		...
		if (isMobile) {
			...
			window.location="https://happygrocery.in/api/admin/";
		}
	</script>
...
<link rel="stylesheet" href="{{ my_asset('frontend/vendor/materializeicon/material-icons.css') }}">

    <!-- Roboto fonts CSS -->
    <link href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700&amp;display=swap" rel="stylesheet">

    <!-- Bootstrap core CSS -->
    <link href="{{ my_asset('frontend/vendor/bootstrap-4.3.1/css/bootstrap.min.css') }}" rel="stylesheet">

    <!-- Swiper CSS -->
    <link href="{{ my_asset('frontend/vendor/swiper/css/swiper.min.css') }}" rel="stylesheet">

    <!-- Chosen multiselect CSS -->
    <link href="{{ my_asset('frontend/vendor/chosen_v1.8.7/chosen.min.css') }}" rel="stylesheet">

    <!-- nouislider CSS -->
    <link href="{{ my_asset('frontend/vendor/nouislider/nouislider.min.css') }}" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="{{ my_asset('frontend/css2/style.css') }}" rel="stylesheet">
	
	<!-- jquery, popper and bootstrap js -->
    <script src="{{ my_asset('frontend/js2/jquery-3.3.1.min.js') }}"></script>
    <script src="{{ my_asset('frontend/js2/popper.min.js') }}"></script>
    <script src="{{ my_asset('frontend/vendor/bootstrap-4.3.1/js/bootstrap.min.js') }}"></script>

    <!-- swiper js -->
    <script src="{{ my_asset('frontend/vendor/swiper/js/swiper.min.js') }}"></script>

    <!-- nouislider js -->
    <script src="{{ my_asset('frontend/vendor/nouislider/nouislider.min.js') }}"></script>

    <!-- chosen multiselect js -->
    <script src="{{ my_asset('frontend/vendor/chosen_v1.8.7/chosen.jquery.min.js') }}"></script>

    <!-- template custom js -->
    <script src="{{ my_asset('frontend/js2/main.js') }}"></script>
...
<script>
    ...
    //     $.post('{{ 1 }}', {_token:'{{ csrf_token() }}'}, function(data){
    //         $('#cart_items').html(data);
    //     });
    // }

    // function removeFromCart(key){
    //     $.post('{{ 1 }}', {_token:'{{ csrf_token() }}', key:key}, function(data){
    //         updateNavCart();
    ...
    function addToCompare(id){
        $.post('{{ 1 }}', {_token:'{{ csrf_token() }}', id:id}, function(data){
            $('#compare').html(data);
        ...
        @if (Auth::check() && (Auth::user()->user_type == 'customer' || Auth::user()->user_type == 'seller'))
            $.post('{{ 1 }}', {_token:'{{ csrf_token() }}', id:id}, function(data){
                if(data != 0){
                    ...
                    document.querySelector('#wishico').innerText = 'favorite';
    ...
    function show_purchase_history_details(order_id)
    {
        ...
        $.post('{{ 1 }}', { _token : '{{ @csrf_token() }}', order_id : order_id}, function(data){
