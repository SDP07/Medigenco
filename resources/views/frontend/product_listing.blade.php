...
@section('content')
                    ...
                    <ul class="breadcrumb">
                        ...
                        @if(!isset($category_id) && !isset($category_id) && !isset($subcategory_id) && !isset($subsubcategory_id))
                                        ...
                                        @if(isset($category_id))
                                            ...
                                            <li class="active"><a href="{{ route('products.category', \App\Category::find($category_id)->slug) }}">Category: {{  translate(\App\Category::find($category_id)->name) }}</a></li>
                            ...
                            <div class="col-xl-7 offset-xl-1">
                                <div class="row no-gutters">
                                   ...
                                   <div class="d-xl-none ml-3 form-group">
                                    <button type="button" class="btn p-4 btn-sm" id="side-filter">
    ...
    margin-left: 80px;height:18px" class=" float-right mt-2"></span>
                                @endif
                                        ...
                                        <img style="height: 130px;" class="img-fit lazyload mx-auto" src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset($product->thumbnail_img) }}" alt="{{ __($product->name) }}">
                                    </a>
