                        ...
                        <h4>My Wallet</h4>
                             ...
                             <div class="card mb-4 border-0 shadow-sm" style="border-radius: 10px;">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-auto">
                                            <span style="border-radius: 15px;" class="btn p-3 shadow btn-base-1">
                                                <i class="material-icons">account_balance_wallet</i>
                                            </span>
                                        </div>
                                        <div class="col pl-0">
                                            <p class="text-secondary mb-1">Balance Available</p>
                                            <h4 class="text-dark my-0">{{ single_price(Auth::user()->balance) }}</h4>
                                        </div>
                                        <div class="col-auto pl-0 align-self-center">
                                            <button style="border-radius: 60px;" onclick="show_wallet_modal()" class="btn shadow btn-base-1"><i class="material-icons">add</i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
