                    ...
                    <div class="col-lg-8">
                        <form action="{{ route('payment.checkout') }}" class="form-default" data-toggle="validator" role="form" method="POST" id="checkout-form">
                            ...
                            <div class="card">
                                ...
                                <h4 class="text-center float-center">Total Pay: {{ single_price($total) }}</h4>   
                                <span class="text-center float-center">Order Amount: {{ single_price($subtotal) }}</span>
                                <span class="text-center float-center">Delivery Charge: {{ single_price($shipping) }}</span>
                                <?php
                                
                                if(Session::has('coupon_discount')){
                                        
                                        $totalsave = Session::get('coupon_discount');
                                        echo '<span class="text-center float-center">Total Saving: '.$totalsave.'</span>';
                                    }else{
                                        echo '<span class="text-center float-center">Total Saving: ₹0.00 Discount</span>';
                                ...
                                <div class="card-body text-center">
                                                    ...
                                                    @if($digital != 1)
                                                        <div class="col-6">
                                                            <label class="payment_option mb-4" data-toggle="tooltip" data-title="Cash on Delivery">
                                                                <input type="radio" id="" name="payment_option" value="cash_on_delivery" class="online_payment" >
                                                                <span>
                                                        ...
                                                        <div class="col-6">
                                                        <label class="payment_option mb-4" >
                                                            <input type="radio" name="payment_option"  value="razorpay" class="online_payment" >
                                                            <span>
                                                                <img loading="lazy"  src="{{ my_asset('frontend/images/icons/cards/rozarpay.png')}}" class="img-fluid">
                                                                <br>
                                    ...
                                    @if (Auth::check() && \App\BusinessSetting::where('type', 'wallet_system')->first()->value == 1)
                                        <div>
                                            <span class="text-center float-center">or</span>
                                        </div>
                                        <div class="row">
                                            <div class="col-xxl-6 col-lg-8 col-md-10 mx-auto">
                                                <div class="text-center bg-gray py-1">
                                                    <i class="fa"></i>
