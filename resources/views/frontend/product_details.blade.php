                              ...
                              <div class="swiper-container">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <img style="height: 200px;" src="{{ my_asset($detailedProduct->thumbnail_img) }}" alt="">
                                                </div>
                        ...
                        <div class="product-description-wrapper">
                            ...
                            <div class="row align-items-center my-1">
                                <div class="col-6">
                                    ...
                                    <div class="rating">
                                        @php
                                            ...
                                            $disco = $detailedProduct->discount;
                                            $dism = str_replace(',00', '', number_format($disco, 0, ',', ''));
                                        @endphp
                                        <span class="star-rating">
                                            {{ renderStarRating($detailedProduct->rating) }}
                                        </span><br>
                                        <span class="rating-count ml-1">({{ $total }} {{ translate('reviews')}})</span><br>
                                        @if ($disco > 0)
                                        <span class="badge badge-danger text-light">{{ $dism }}% OFF</span>
                                        @else
                                ...
                                <div class="col-6 text-right">
                                    ...
                                    @php
                                    $mydd = Auth::user()->id;
                                    $productwish = App\Models\Wishlist::where(['product_id' => $detailedProduct->id, 'user_id' => $mydd])->count();
                                    
                                    @endphp
                                    
                                     @if ($productwish > 0)
                                     <button  class="btn btn-sm btn-link p-0"><i id="wishico" style="font-size: 25px;color:red;" class="material-icons md-18">favorite</i></button>
                                     @else
                                     <button onclick="addToWishList({{ $detailedProduct->id }})" class="btn btn-sm btn-link p-0"><i id="wishico" style="font-size: 25px;color:red;" class="material-icons md-18">favorite_outline</i></button>
                                     @endif
                                    @else
                                     <button onclick="window.location.href=('{{ route('user.login') }}')" class="btn btn-sm btn-link p-0"><i id="wishico" style="font-size: 25px;color:red;" class="material-icons md-18">favorite_outline</i></button>
                                    @endauth
                                </div>
                            </div>
                                ...
                                <div class="row no-gutters pb-1 d-none" id="chosen_price_div">
                                    ...
                                    <div class="col-10" >
                                        <div class="product-price">
                                            <strong class="text-success" id="chosen_price">
                                    ...
                                    <div class="col-10" hidden>
                                        <div class="product-price">
                                            <strong class="text-success">
                                                {{ $detailedProduct->purchase_price }}
                            ...
                            <div class="d-table width-100 mt-1">
                                <div class="d-table-cell">
                                    <!-- Buy Now button -->
                                    @if ($qty > 0)
                                        <button type="button" class="btn btn-styled btn-base-1 btn-icon-left strong-700 hov-bounce hov-shaddow add-to-cart" onclick="addToCart()">
                                            <i style="font-size: 31px;" class="la la-shopping-cart"></i> {{ translate('Buy Now')}}
                                        </button>
