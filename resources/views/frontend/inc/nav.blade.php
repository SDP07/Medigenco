...
<hr></hr>
                        ...
                        <li>
                            <a href="https://happygrocery.in/api/legalterms" >
                         ...
                         <li>
                            <a href="https://happygrocery.in/api/aboutus" >
                                <i class="la la-file-text"></i>
                                <span class="category-name">
                                    About Us
                                </span>
                        ...
                        <div class="d-flex w-100">
                            ...
                            <div class="logo-bar-icons d-inline-block ml-auto">
                                ...
                                <div class="d-inline-block" data-hover="dropdown">
                                   {{--  <div class="nav-cart-box dropdown" id="cart_items" onclick="window.location.href='{{ route('cart') }}'"> --}}
                                        <a href="" class="nav-box-link" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i style="font-size:35px" class="la la-shopping-cart d-inline-block nav-box-icon"></i>
