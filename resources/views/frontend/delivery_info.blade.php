            ...
            <div class="container">
                <div class="row cols-xs-space cols-sm-space cols-md-space">
                    <div class="col-xl-8">
                        ...
                        <h5>Select Delivery Date & Time</h5>
                        <label class="label text-warning text-center">Select Date</label>
                        
                        
                        
                        <div class="demo-swiper-custom">
                            <div  data-navigation='{"nextEl": ".aar2", "prevEl": ".aar1"}' data-space-between="0" class="swiper-container">
                                <div class=""></div>
...
$dtm = date('d-M-Y');
$dtp1 = date('d-M-Y', strtotime($dtm. ' + 7 days'));
...
while (strtotime($start_date) <= strtotime($end_date)) {
 ...
 echo '<h4 style="background-color:transparent;" class="swiper-slide text-center">'.$start_date.'</h4>';
}

?>
                                    
                                </div>
                                <span class="material-icons aar1">keyboard_arrow_left</span>
                                <span class="material-icons aar2 float-right">keyboard_arrow_right</span>
                            </div>
                        </div>
                        
                        <form >
                            
                            <label class="label subtitle text-warning" for="time">Select Time:</label><br>
                            <div class="input-group subtitle mb-1 mt-1">
                                
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" name="option" class="custom-control-input" id="customradio1" checked="">
                                        <label class="custom-control-label" for="customradio1">12 AM - 3 PM</label>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" name="option" class="custom-control-input" id="customradio2">
                                        <label class="custom-control-label" for="customradio2">3 PM - 6 PM</label>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" name="option" class="custom-control-input" id="customradio2">
                                        <label class="custom-control-label" for="customradio2">6 PM - 9 PM</label>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                    <label class="label subtitle text-warning" >Delivery Notes</label>
                    ...
                    <div class="col-lg-4 ml-lg-auto" hidden>
