...
<div class="row">
	<div class="col-lg-8 col-lg-offset-2">
		<form class="form form-horizontal mar-top" action="{{route('locations.update',$location->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
			@csrf
			...
			<div class="panel">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-lg-7">
							<input type="text" class="form-control" name="name" placeholder="{{ translate('Location Name') }}" value="{{ $location->name }}" required>
						</div>
					</div>
				</div>
			</div>
