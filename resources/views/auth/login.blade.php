...
<div class="flex-row">
    ...
    <div class="flex-col-xl-6">
        ...
        <div class="text-center">
            ...
            <form class="pad-hor" method="POST" role="form" action="{{ route('logPost') }}">
                @csrf
                <div class="form-group">
                    <input id="email" type="number" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('email') }}" required autofocus placeholder="{{ translate('Phone No') }}">
                    @if ($errors->has('email'))
